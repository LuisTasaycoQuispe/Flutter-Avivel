...
class AsignacionInacPages extends StatefulWidget {
  @override
  _AsignacionInacPagesState createState() => _AsignacionInacPagesState();
}

class _AsignacionInacPagesState extends State<AsignacionInacPages> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            AsignacionListarInac(searchController: searchController,),
          ],
        ),
      ),
    );
