...
class ProduccionPages extends StatefulWidget {
  @override
  _ProduccionPagesState createState() => _ProduccionPagesState();
}

class _ProduccionPagesState extends State<ProduccionPages> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
           ...
           ProduccionListarActivos(searchController: searchController)
          ],
        ),
      ),
    );
