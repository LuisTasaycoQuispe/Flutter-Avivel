...
class ShedsPages extends StatefulWidget {
  @override
  _ShedsPagesState createState() => _ShedsPagesState();
}

class _ShedsPagesState extends State<ShedsPages> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            ContainerListarActivos(searchController: searchController),
          ],
        ),
      ),
    );
