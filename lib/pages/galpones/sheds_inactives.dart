...
class ShedsInactivesPages extends StatefulWidget {
  @override
  _PersonInacPagesState createState() => _PersonInacPagesState();
}

class _PersonInacPagesState extends State<ShedsInactivesPages> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            ContainerListarInactivos(searchController: searchController),
          ],
        ),
      ),
    );
