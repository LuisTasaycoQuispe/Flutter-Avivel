...
class PersonPages extends StatefulWidget {
  const PersonPages({Key? key}) : super(key: key);

  @override
  _PersonPagesState createState() => _PersonPagesState();
}

class _PersonPagesState extends State<PersonPages> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            PersonaListarActivos(searchController: searchController),
          ],
        ),
      ),
    );
